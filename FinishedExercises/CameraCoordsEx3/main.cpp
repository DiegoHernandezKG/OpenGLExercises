...
int main()
{
    ...
    float t_color[4] = {1.0f, 1.0f, 1.0f, 1.0f};
    glm::vec3 v_color = glm::vec3(1.0f);
    ...
    /*
    /Model matrix that we wish to apply to all objects in the global space
    glm::mat4 model = glm::mat4(1.0f);
    //model = glm::rotate(model, glm::radians(-55.0f), glm::vec3(1.0f, 0.0f, 0.0f));
    //Now the view matrix
    glm::mat4 view = glm::mat4(1.0f);
    //since we are translating the scene in the opposite direction of where we want to move
    //we need to move the entire scene in the reverse direction
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        projection = glm::perspective(glm::radians(45.0f), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
        view = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f));
        trans = glm::rotate(trans,rotation * (float)glfwGetTime(),glm::vec3(1.0f, 0.0f, 1.0f));
